  ...
  return (
    <>
      <div className='w-full px-32'>
        ...
        <div className='w-screen border-sage-500 border bg-radial-[at_50%_20%] from-sage-500 to-bg-khaki ml-[-132px] px-24 flex gap-32 items-center py-28 justify-between z-20'>
